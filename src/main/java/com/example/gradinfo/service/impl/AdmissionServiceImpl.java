...
public class AdmissionServiceImpl implements AdmissionService {
    ...
    public AdmissionCourseApplyResponse getPostAdmissionCourseTableDataByNewArr(AdmissionCourseRequest admissionCourseRequest) {
        ...
        List<String> reason = commonService.checkReason(sysAdmissionCourseEntityListForReason, sysTransferCourseEntityListForReason);
            ...
            List<SysAdHistoryEntity> sysAdHistoryEntityList = new ArrayList<>();
            List<SysAdmissionCourseEntity> sysAdmissionCourseEntityArrayList = new ArrayList<>();
            for (SysAdmissionCourseEntity sysAdmissionCourseEntity :sysAdmissionCourseEntityList) {
                ...
                if (map.containsKey(courseId)) {
                    if (sysAdmissionCourseEntity.getAdCourseApplyStatus() == 0) {
                        ...
                        sysAdHistoryEntityList.add(sysAdHistoryEntity);
                    }
                ...
                sysAdmissionCourseEntityArrayList.add(sysAdmissionCourseEntity);

            }
            for (SysAdmissionCourseEntity sysAdmissionCourseEntity : sysAdmissionCourseEntityArrayList) {
                System.out.print(sysAdmissionCourseEntity.getAdCourseName());
                System.out.println(sysAdmissionCourseEntity.getAdCourseApplyStatus());
            }

            admissionCourseRepository.saveAllAndFlush(sysAdmissionCourseEntityArrayList);
            admissionHistoryRepository.saveAllAndFlush(sysAdHistoryEntityList);
            ...
            AdmissionCourseApplyResponse admissionCourseApplyResponse = new AdmissionCourseApplyResponse();
            admissionCourseApplyResponse.setFlag(false);
            String str = "catch error";
            List<String> list1 = new ArrayList<>();
            list1.add(str);
            admissionCourseApplyResponse.setReasonList(list1);
            return admissionCourseApplyResponse;
        }
