...
public class SysTransferCourseEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(trCourseId, that.trCourseId) && Objects.equals(studentPostId, that.studentPostId) && Objects.equals(institutionId, that.institutionId) && Objects.equals(trHistoryId, that.trHistoryId) && Objects.equals(trCourseNumber, that.trCourseNumber) && Objects.equals(trCourseName, that.trCourseName) && Objects.equals(trCourseUnits, that.trCourseUnits) && Objects.equals(trCourseLevel, that.trCourseLevel) && Objects.equals(trCourseTerm, that.trCourseTerm) && Objects.equals(trCourseGrade, that.trCourseGrade) && Objects.equals(trCourseGpts, that.trCourseGpts) && Objects.equals(trCourseApplyStatus, that.trCourseApplyStatus) && Objects.equals(trCourseApplyCode, that.trCourseApplyCode) && Objects.equals(trCourseOper, that.trCourseOper) && Objects.equals(trCourseTransdate, that.trCourseTransdate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(trCourseId, studentPostId, institutionId, trHistoryId, trCourseNumber, trCourseName, trCourseUnits, trCourseLevel, trCourseTerm, trCourseGrade, trCourseGpts, trCourseApplyStatus, trCourseApplyCode, trCourseOper, trCourseTransdate);
    }
}
